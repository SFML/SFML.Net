...
namespace SFML.System
{
	...
	public struct Vector2i : IEquatable<Vector2i>
	{
		...
		/// <returns>Casting result</returns>
		////////////////////////////////////////////////////////////
		public static explicit operator Vector2f(Vector2i v) => new Vector2f((float)v.X, (float)v.Y);
	...
	public struct Vector2u : IEquatable<Vector2u>
	{
		...
		/// <returns>Casting result</returns>
		////////////////////////////////////////////////////////////
		public static explicit operator Vector2f(Vector2u v) => new Vector2f((float)v.X, (float)v.Y);
